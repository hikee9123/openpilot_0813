...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    ret.atomLongitudinalControl = Params().get_bool("OpkratomLongitudinal")  and (candidate in LEGACY_SAFETY_MODE_CAR)
    ...
    if candidate in [CAR.GRANDEUR_HEV_19]:
      ...
      ret.lateralTuning.lqr.dcGain =  0.0030  #0.0027  #0.00285   # 0.002237852961363602
